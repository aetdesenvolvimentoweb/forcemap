...
import { makeMilitaryRankInputDTOSanitizer } from "@main/factories/sanitizers";
import { makeMilitaryRankValidator } from "@main/factories/validators";
...
export const makeCreateMilitaryRankUseCase = (): CreateMilitaryRankUseCase => {
  ...
  const validator = makeMilitaryRankValidator({ militaryRankRepository });
