import {
  ...
  mockMakeCreateMilitaryController,
  mockMakeDeleteMilitaryController,
  mockMakeFindByIdMilitaryController,
  mockMakeListAllMilitaryController,
  mockMakeUpdateMilitaryController,
  mockRouter,
  mockRouterMethods,
} from "../../../../__mocks__";
